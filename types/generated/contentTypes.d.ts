...
export interface ApiCartCart extends Schema.CollectionType {
  ...
  attributes: {
    user: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    products: Attribute.Component<'product.cart', true>;
...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    products: Attribute.Component<'order.order-list', true>;
    user: Attribute.Relation<
      'api::order.order',
      'oneToMany',
      'plugin::users-permissions.user'
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    beforeDiscount: Attribute.Decimal;
    price: Attribute.Decimal &
      ...
      Attribute.SetMinMax<
        ...
        number
      >;
    productDetails: Attribute.Component<'product.product-meta', true>;
    additionalMeta: Attribute.Component<'product.product-meta', true>;
